...
class OVRTXRenderer(BaseRenderer):
    ...
    def _extract_rgba_tiles(
        ...
        """Extract all RGBA tiles from tiled buffer into output_buffers in a single kernel launch."""
        wp.launch(
    ...
    def _extract_depth_tiles(
        ...
        """Extract all depth tiles from tiled depth buffer into output_buffers in a single kernel launch."""
